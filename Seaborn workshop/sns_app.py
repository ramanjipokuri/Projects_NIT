...
st.title('Data visualization app by Streamlit and Seaborn')
st.sidebar.title('Data visualization app by Seaborn')
st.sidebar.write("This is a simple app to visualize the tips dataset using seaborn.")
